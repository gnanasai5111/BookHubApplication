...
import com.marvel.bookhub.adapter.FavouriteRecyclerAdapter
...
class FavouritesFragment : Fragment() {
    ...
    lateinit var reyclerFavourite:RecyclerView
    ...
    override fun onCreateView(
        ...
        reyclerFavourite=view.findViewById(R.id.recyclerFavourite)
        ...
        if (dbBookList!=null && activity!=null)
        {
            ...
            recyclerAdapter=FavouriteRecyclerAdapter(activity as Context,
                dbBookList as ArrayList<BookEntity>
            )
            reyclerFavourite.adapter=recyclerAdapter
            reyclerFavourite.layoutManager=layoutManager
        }
