package com.marvel.bookhub.adapter
...
class FavouriteRecyclerAdapter(val context:Context,val bookList:ArrayList<BookEntity>):RecyclerView.Adapter<FavouriteRecyclerAdapter.FavouriteViewHolder>(){
